  ...
  return (
    <section id="what-legal-bases-do-we-rely-on-to-process-your-personal-information">
      ...
      <div className="space-y-6">
        <div>
          <h3 className="text-base font-semibold italic underline text-gray-900 mb-3">
          ...
          <ul className="list-disc pl-6 space-y-4 text-gray-700">
            ...
            <li className="text-xs md:text-sm">
              ...
              <ul className="list-disc pl-6 mt-2 space-y-1">
                ...
                <li className="text-xs md:text-sm">
                  To tailor matches and suggestions based on user preferences
                  and behavior.
                </li>
                <li className="text-xs md:text-sm">
                  To understand trends, retention, and feature performance
