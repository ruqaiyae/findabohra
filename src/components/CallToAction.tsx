...
export function CallToAction() {
  return (
    <section className="relative w-full md:pb-20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:pt-20 md:pb-0 relative z-10 grid lg:grid-cols-2 gap-10 md:gap-30 items-center bg-gradient-to-br from-[#581C87] to-[#BE185D] md:bg-none">
        {/* Left Content */}
