        ...
        <div className="max-w-5xl mx-auto">
          <div className="space-y-12">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-2xl w-[90%] mx-auto p-8 border border-purple-100 text-gray-900">
                <h3 className="text-2xl mb-4 font-bold">Our goal?</h3>{" "}
                <p>
            ...
            <div className="space-y-6 w-[92%] mx-auto">
              <div className="grid gap-4">
                {/* Culturally Aligned */}
                <div className="flex items-start space-x-4 p-4 bg-white rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
            ...
            {/* Community Section */}
            <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-2xl mx-auto p-8 border border-purple-100">
              <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">
                More Than Just Matches—A Community Built for Love
              </h3>
